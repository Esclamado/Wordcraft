...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::get('/refund-request-reject/{id}', 'RefundRequestController@request_reject')->name('refund_request_reject');
...
Route::group(['middleware' => ['user', 'verified']], function(){
    ...
    Route::get('refund-requests/lists', 'RefundRequestController@request_lists')->name('refund_request_lists');
});
