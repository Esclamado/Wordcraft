...
// Order Transactions
Route::post('/paynamics/query/payment-processing-check', 'PaynamicsController@query_payment_processing_check');
Route::post('/paynamics/handle-webhook-response', 'PaynamicsController@handle_webhook_response')->name('handle_paynamics_webhook');

// Wallet Transactions
Route::post('/paynamics/handle-webhook-response-wallet', 'PaynamicsController@handle_webhook_response_wallet')->name('handle_paynamics_webhook_wallet');

// Worldcraft API Inventory Syncing
Route::post('/worldcraft/inventory-syncing', 'WorldcraftApiController@stocks_update');
Route::post('/worldcraft/inventory/add-stocks', 'WorldcraftApiController@add_stocks');
Route::post('/worldcraft/inventory/delete-stock', 'WorldcraftApiController@remove_stock');
Route::get('/worldcraft/get/all-products', 'WorldcraftApiController@get_all_products');

/* Walkin */
Route::group(['prefix' =>'walkin'], function(){
	/* Auth */
	Route::post('login', 'Walkin\Api\Auth\AuthController@login')->name('auth.login');
});