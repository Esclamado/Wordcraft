...
class PurchaseHistoryController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('frontend.user.purchase_order_details', compact('order'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function show_upload_receipt($id)
    {
        $order = Order::where('id', decrypt($id))->firstOrFail();

        return view('frontend.user.purchase_order_upload_receipt', compact('order'));
    }
