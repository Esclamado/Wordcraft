...
class PageController extends Controller
{
   ...
   public function edit(Request $request, $id)
   {
    ...
    /**
     * [paynamics_response_url description]
     * @return [type] [description]
     */
    public function paynamics_response_url()
    {
        return view('frontend.paynamics.response_url');
    }

    public function paynamics_cancel_url()
    {
        return view('frontend.paynamics.cancel_url');
    }
}
