...
class RouteServiceProvider extends ServiceProvider
{
	...
	protected function mapMlmRoutes()
	{
		Route::prefix('mlm/api/v1')
			->middleware('api')
			->namespace($this->namespace)
			->group(base_path('routes/mlm/v1/api.php'));
	}
	...
	/**
	 * Define the 'paynamics' routes for the application
	 *
	 * @return void
	 */
	protected function mapPaynamicsRoutes()
	{
		Route::middleware('web')
			->namespace($this->namespace)
			->group(base_path('routes/paynamics.php'));
	}
}
