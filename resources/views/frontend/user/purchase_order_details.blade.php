    ...
    <div class="container">
        <div class="d-lg-flex align-items-start">
            ...
            <div class="aiz-user-panel">
                <a href="{{ route('purchase_history.index') }}" class="back-to-page d-flex align-items-center">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('customer.invoice.download', $order->id) }}" class="order-details-download-invoice">
                ...
                @php
                    ...
                    if ($order->payment_option != 'paynamics' && $order->payment_option == 'other-payment-method') {
                ...
                @if ($order->payment_status != 'paid')
                    @if ($payment_method == 'multiple_payment_option' || $payment_method == 'e_wallet' && $order->user_id == Auth::user()->id)
                            ...
                            <div class="col-lg-6">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td class="order-details-subtitle px-0 py-2">{{ date('d-m-Y h:i A', $order->date) }}</td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-lg-6">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        @endphp
                                        <td class="w-50 order-details-title px-0 py-2" style="text-transform: capitalize;">{{ translate('Payment Method')}}:</td>
                                        <td class="order-details-subtitle px-0 py-2">
                                            ...
                                            @if ($order->payment_option == 'paynamics' && $order->payment_status != 'paid')
                                                <span id="check_payment_id" class="refresh c-pointer text-success ml-1" onclick="check_payment()" title="Check Payment Status">
                                                    <i id="icon-check" class="las la-undo-alt"></i>
                                                    <span id="check-text" style="display: none;"></span>
                                                </span>
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="w-50 order-details-title px-0 py-2" style="text-transform: capitalize;">{{ translate('Pickup Point') }}:</td>
                                        <td class="order-details-subtitle px-0 py-2">
                                            @php
                                            ...
                                            <tr>
                                                ...
                                                @if ($order->user_id == Auth::user()->id)
                                                    @if ($refund_request_addon != null && $refund_request_addon->activated == 1)
                                                        ...
                                                        <td class="order-details-subtitle text-center">
                                                            @if ($orderDetail->product != null)
                                                                @if ($orderDetail->product->refundable != 0 && $orderDetail->refund_request == null && $today_date <= $last_refund_date && $orderDetail->delivery_status == 'picked_up')
                                                                ...
                                                                @elseif ($orderDetail->product->refundable != 0)
                                                                    <b class="text-muted">{{  translate('N\A') }}</b>
                                                                @else
                                                                    <b>{{  translate('N\A') }}</b>
                                                                @endif
                                                            @else
                                ...
                                <div class="order-details-amount-summary mt-4 mt-md-0">
                                    ...
                                    <table class="table table-borderless">
                                        <tbody>
                                            ...
                                            @endif
                                            <tr>
                                                <td class="w-50 order-details-amount-summary-subtitle px-0 py-2" style="text-transform: capitalize;">{{ translate('Tax')}}</td>
                                                <td class="text-right order-details-amount px-0 py-2">
