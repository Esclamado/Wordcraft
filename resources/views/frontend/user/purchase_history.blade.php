                        ...
                        <div class="col-md-6 col-12">
                            <div class="float-md-right">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active"><a href="{{ route('purchase_history.index') }}" class="text-breadcrumb text-secondary-color fw-600">{{ translate('My Purchase History') }}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                @if (count($orders) != 0)
                    @foreach ($orders as $key => $order)
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                   <div class="customer-craft-dashboard-card-title mb-0 col-6"> Order Code: <span style="color: #161DBC;">{{ $order->code ?? "N/A" }}</span></div>
                                        <div class="col-6 dropdown d-flex justify-content-end" style="float:right;">
                                            <button class="dropbtn customer-craft-dashboard-card-title py-1" style="text-align: right;">View Order Details</button>
                                            <div class="dropdown-content bg-white fw-300 mt-lg-4 mt-5">
                                                <a href="{{ route('purchase_history.show', encrypt($order->id ?? "N/A")) }}">View Order Details</a>
                                                <a href="{{ route('customer.invoice.download', $order->id ?? "N/A") }}">Download Invoice</a>
                                            </div>
                                        </div>
                                    </div>
                                <hr>
