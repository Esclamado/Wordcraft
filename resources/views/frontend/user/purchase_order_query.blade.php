            ...
            <div class="col-12 col-lg-10 mx-auto">
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-center align-items-center pt-4">
                            <div class="text-center mb-4 w-100 w-md-50">
                                ...
                                <div class="order-confirmed-subtitle">
                                    @if ($response_code == 'GR001')
                                        {{ $response_message }} for Order # <b><a href="{{ route('purchase_history.show', encrypt($order->id)) }}">{{ $order->code }}</a></b>
                                    @elseif ($response_code == 'GR033')
                                    ...
                                    @elseif ($response_code == 'GR003')
                                        {{ $response_message }}! Your order is now cancelled. You may order the same item again and try another payment method.
                                    @elseif ($response_code == 'GR122')
                                        Transaction not found! Please try again, or you can process a new order.
                                    @elseif ($response_code == 'GR152')
                                        Cannot process transaction because it was expired prior to payment
                                    @endif
                                </div>

                                @if ($response_code != 'GR003' && $response_code != 'GR122')
                        ...
                        @if ($response_code != 'GR003' && $response_code != 'GR001')
                            @php
