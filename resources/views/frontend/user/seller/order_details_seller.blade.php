        ...
        <div class="col-lg-4 col-sm-6">
            <div class="form-group">
                <select class="form-control aiz-selectpicker form-control-sm"  data-minimum-results-for-search="Infinity" id="update_delivery_status">
                    <option value="order_placed" @if ($status == 'order_placed') selected @endif>{{ translate('Order Placed')}}</option>
                    ...
                    <option value="partial_release" @if ($status == 'partial_release') selected @endif>{{ translate('Partial Release')}}</option>
                    <option value="ready_for_pickup" @if ($status == 'ready_for_pickup') selected @endif>{{ translate('Ready for Pickup')}}</option>
