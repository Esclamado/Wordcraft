    ...
    <div class="container">
        <div class="d-flex align-items-start">
            ...
            <div class="aiz-user-panel">
                ...
                <div class="d-flex align-items-start">
                    <a href="{{ route('employee.my_customer_orders') }}" class="card-tab card-tab-active mr-3">
                        Customer Orders
                    </a>

                    <a href="{{ route('employee.my_customer_orders_returns') }}" class="card-tab mr-3">
                        Returns
                    </a>
                </div>
                <div class="card card-craft-min-height border-0 shadow-none rounded-0 card-mobile-res">
                            ...
                            <div class="d-flex justify-content-center align-items-center card-craft-min-height">
                                <div class="text-center">
                                    ...
                                    <h3 class="cart-craft-text mb-0 mt-3">
                                        Your customer orders history is empty.
                                    </h3>
                                </div>
                            </div>
                        @endif
