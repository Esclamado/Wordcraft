    ...
    <div class="container">
        <div class="d-lg-flex align-items-start">
            ...
            <div class="aiz-user-panel">
                <a href="{{ route('employee.my_customer_orders') }}" class="back-to-page d-flex align-items-center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="order-details-subtitle px-0 py-2">
                                            ...
                                            @if ($order->payment_option == 'paynamics' && $order->payment_status != 'paid')
                                                <br>
                                                <span class="refresh c-pointer text-danger" onclick="check_payment()">Check Payment Status</span>
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="w-50 order-details-title px-0 py-2">{{ translate('Pickup Point') }}:</td>
                                        <td class="order-details-subtitle px-0 py-2"> {{ $order->pickup_point_location }}
                                        </td>
                                    </tr>
                                </table>
                            </div>
