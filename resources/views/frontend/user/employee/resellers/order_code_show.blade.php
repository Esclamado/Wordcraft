    ...
    <div class="container">
        <div class="d-lg-flex align-items-start">
            ...
            <div class="aiz-user-panel">
                <a href="{{ route('employee.my_earnings') }}" class="back-to-page d-flex align-items-center">
                            ...
                            <div class="col-lg-6">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td class="order-details-subtitle px-0 py-2">
                                            {{ ucfirst(str_replace('_', ' ', $order->payment_type ?? "N/A")) }}
                                            ...
                                            <tr>
                                                ...
                                                <td class="order-details-subtitle">
                                                    @if ($orderDetail->product != null)
                                                        <a href="{{ route('product', $orderDetail->product->slug ?? "N/A") }}" target="_blank">{{ $orderDetail->product->getTranslation('name') ?? "N/A" }}</a>
                                                    @else
