        ...
        <div class="d-flex align-items-start">
            @include('frontend.inc.user_side_nav')
                <div class="aiz-user-panel">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="float-md-right">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active"><a href="{{ route('employee.my_customer_orders') }}" class="text-breadcrumb text-secondary-color fw-600">{{ translate('Customer Orders') }}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex justify-content-between w-100">
                                    <div>
                                        <div class="cart-craft-count-title">
                                            @php
                                                $pending_orders = \App\EmployeeCustomerOrder::where('employee_id', Auth::user()->id)
                            ...
                            <div class="cart-craft-count cart-craft-count-primary">
                                <div class="d-flex justify-content-between w-100">
                                    <div>
                                        <div class="cart-craft-count-title">
                                            @php
                                                $orders_id = \App\EmployeeCustomerOrder::where('employee_id', Auth::user()->id)
                                                    ->pluck('order_id');
                            ...
                            <div class="cart-craft-count" style="background: var(--primary-red);">
                                <div class="d-flex justify-content-between w-100">
                                    <div>
                                        <div class="cart-craft-count-title">
                                            @php
                                                $declined_orders = \App\EmployeeCustomerOrder::where('employee_id', Auth::user()->id)
                            ...
                            <div class="cart-craft-count cart-craft-count-success">
                                <div class="d-flex justify-content-between w-100">
                                    <div>
                                        <div class="cart-craft-count-title">
                                            @php
                                                $successful_orders = \App\EmployeeCustomerOrder::where('employee_id', Auth::user()->id)
                            ...
                            <div class="cart-craft-count cart-craft-count-info">
                                <div class="d-flex justify-content-between w-100">
                                    <div>
                                        <div class="cart-craft-count-title">
                                            @php
                                                $total_orders = \App\EmployeeCustomerOrder::where('employee_id', Auth::user()->id)
                                                    ->distinct()
                                                    ->count();
                                            @endphp
                    ...
                    <div class="d-flex align-items-start">
                        <a href="{{ route('employee.my_customer_orders') }}" class="card-tab mr-3">
                            Customer Orders
                        </a>

                        <a href="{{ route('employee.my_customer_orders_returns') }}" class="card-tab card-tab-active mr-3">
                            Returns
                        </a>
                    </div>
                                                ...
                                                <tbody>
                                                    @if (Auth::user()->user != null)
                                                        @foreach ($orders as $key => $order)
                                                            <tr>
                                                                <td class="table-data">
                                                                    <a href="{{ route('purchase_history.show', encrypt($order->order_id)) }}">
                                                                        {{ $order->order->code ?? "N/A" }}
                                                                    </a>
                                                                </td>
                                                                <td class="table-data" style="min-width: 200px;">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="mr-2">
                                                                            <img
                                                                                class="img-fluid lazyload craft-purchase-history-image-2 mr-2"
                                                                                src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                                                                data-src="{{ uploaded_asset($order->orderDetail->product->thumbnail_img ?? "N/A") }}"
                                                                                onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';"
                                                                            >
                                                                        </div>
                                                                        <div>
                                                                            {{ $order->orderDetail->product->getTranslation('name') ?? "N/A" }}
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="table-data">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="mr-2">
                                                                            @if ($order->user != null) 
                                                                                @if ($order->user->avatar_original != null)
                                                                                    <img src="{{ uploaded_asset($order->user->avatar_original) ?? "N/A" }}" class="image rounded-circle table-user-image" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.png') }}';">
                                                                                @else
                                                                ...
                                                                <td class="table-data text-center delivery-status-mobile">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center card-craft-min-height">
                                            <div class="text-center">
                                                ...
                                                <h3 class="cart-craft-text mb-0 mt-3">
                                                    Your customer order returns is empty.
                                                </h3>
                                            </div>
                                        </div>
                                    @endif
