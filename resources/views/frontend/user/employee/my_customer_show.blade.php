    ...
    <div class="container">
        <div class="d-flex align-items-start">
            ...
            <div class="aiz-user-panel">
                <a href="{{ route('employee.my_customers') }}" class="back-to-page d-flex align-items-center">
                    ...
                    <div class="card-body">
                        ...
                        @if (count($transaction_histories) != 0)
                            <table class="table aiz-table mb-0">
                                ...
                                <tbody>
                                    @foreach ($transaction_histories as $key => $order)
                                        @php
                        ...
                        @endif
                        {{ $transaction_histories->links() ?? "N/A" }}
                    </div>
                </div>
            </div>
        </div>
