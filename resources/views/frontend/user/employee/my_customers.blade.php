    ...
    <div class="container">
        <div class="d-flex align-items-start">
            ...
            <div class="aiz-user-panel">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="float-md-right">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active"><a href="{{ route('employee.my_customers') }}" class="text-breadcrumb text-secondary-color fw-600">{{ translate('My Customers') }}</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-craft-min-height mt-2 card-mobile-res1">
                                            ...
                                            <tbody>
                                                @foreach ($customers as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td class="table-data">
                                                            <a href="{{ route('employee.my_customer.show', encrypt($value->id ?? "N/A")) }}">
