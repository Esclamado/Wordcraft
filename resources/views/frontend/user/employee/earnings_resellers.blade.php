    ...
    <div class="container">
        <div class="d-flex align-items-start">
            ...
            <div class="aiz-user-panel">
                ...
                <div class="d-flex align-items-start">
                    <a href="{{ route('employee.my_earnings') }}" class="card-tab mr-3 mobile-card-text">
                        Earned from my customers
                    </a>

                    <a href="{{ route('employee.my_earnings_reseller') }}" class="card-tab card-tab-active mr-3 mobile-card-text">
                            ...
                            <div class="col-12 col-lg-4">
                                <form class="" action="" method="GET">
                                    <div class="form-group position-relative">
                                        <input type="text" name="search" id="search" class="form-control form-control-lg" @isset($sort_search) value="{{ $sort_search }}" @endisset placeholder="Search order code">
                                        <button type="submit" class="p-0 border-0">
                                            <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg" style="top: 16px; right: 15px; position: absolute;">
                        ...
                        @if (count($earnings) != 0)
                            ...
                            <div>
                                <table class="table aiz-table mb-0">
                                    <thead>
                                        <tr>
                                            <th class="table-header">Reseller</th>
                                    ...
                                    <tbody>
                                        @foreach ($earnings as $key => $earning)
                                            <tr>
                                                <td class="table-data">
                                                    <a href="{{ route('employee.my_reseller_show', encrypt($earning->reseller_id)) }}">
                                                ...
                                                <td class="table-data">
                                                    <a href="{{ route('employee.my_earnings_reseller.order_show', encrypt($earning->id ?? "N/A")) }}">
                                                        {{ $earning->code }}
                                                    </a>
                                                </td>
