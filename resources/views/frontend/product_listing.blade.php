                                    ...
                                    <div>
                                        <ul class="list-unstyled pb-3">
                                            @if (Route::currentRouteName() == 'search')
                                                <li class="px-4 py-2 {{ areActiveRoutes(['search']) ? 'active-category' : '' }}">
                                                    <a href="{{ route('search') }}" class="text-reset fs-14 promotion-body">{{ translate('All Categories') }}</a>
                                                </li>
                                            @endif

                                            @if (!isset($category_id))
                                                @foreach (\App\Category::where('level', 0)->get() as $category)
                                                        <li class="px-4 py-2 {{ areActiveRoutes(['products.category', $category->slug]) ? 'active-category' : '' }}">
                                                            <a class="text-reset fs-14 promotion-body" href="{{ route('products.category', $category->slug) }}">
                                            ...
                                            @else
                                                <li class="px-4 py-2">
                                                    <a href="{{ route('search') }}" class="text-reset fs-14">{{ translate('All Categories') }}</a>
                                                </li>
                                                @if (\App\Category::find($category_id)->parent_id != 0)
                                                    <li class="px-4 py-2 {{ areActiveRoutes(['products.category', \App\Category::find(\App\Category::find($category_id)->parent_id)->slug]) ? 'active-category' : '' }}">
                                                        <a class="text-reset fs-14 promotion-body" href="{{ route('products.category', \App\Category::find(\App\Category::find($category_id)->parent_id)->slug) }}">
                                                            <div class="d-inline-flex">
                                                                <div>
                                                                    <img
                                                                        class="cat-image lazyload mr-2 opacity-60"
                                                ...
                                                <li class="px-4 py-2 {{ areActiveRoutes(['products.category', $slug]) ? 'active-category' : '' }}">
                                                    <a class="text-reset fs-14" href="{{ route('products.category', $slug) }}">
                                                        <div class="d-inline-flex">
                                                            <div>
                                                                <img
                                                                    class="cat-image lazyload mr-2 opacity-60"
                    ...
                    <div class="col-xl-9">
                                        ...
                                        <h1 class="fw-600 text-body desktop-content my-0">
                                            <ul class="breadcrumb bg-transparent p-0  fs-14" style="margin-bottom: 41px;">
                                                <li class="breadcrumb-item1 opacity-50">
                                                    <a class="text-reset fw-400" href="{{ route('home') }}">{{ translate('Home')}}</a>
                                                </li>
                                                @if(!isset($category_id))
                                                    <li class="breadcrumb-item1 fw-600  text-dark">
                        ...
                        @if (count($products) != 0) 
                            ...
                            <div class="row gutters-6 row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2">
                                ...
                                <div class="col mb-4">
                                    <a href="{{ route('product', $product->slug) }}" class="card-block stretched-link text-decoration-none">
