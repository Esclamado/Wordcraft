                ...
                <div class="text-left">
                    <div class="row">
                        <div class="col-xxl-8 col-xl-8 mx-auto">
                            <form class="form-default" action="{{ route('walkin.payment.checkout') }}" method="post"
                                id="checkout-form">
                                @csrf
                        ...
                        <div class="col-xxl-4 col-xl-4 mx-auto">
                            @include('frontend.walkin.partials.cart_summary')
                        </div>
                    </div>
                    <div class="row">
                        <div hidden class="col-xxl-8 col-xl-8">
