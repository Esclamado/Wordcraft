...
<div class="modal-body p-4 added-to-cart">
    <div class="text-center text-success mb-4">
        ...
        <h3 class="header-subtitle mt-3">{{ translate('Item added to your order!')}}</h3>
    </div>
    ...
    <div class="text-center mb-3">
        ...
        <a href="{{ route('cashier.order.view', [$orderId, 'edit=1']) }}" class="btn btn-primary mb-3 mb-sm-0 btn-craft-primary-nopadding ml-md-2 ml-lg-2 fw-600">{{ translate('View Order')}}</a>
    </div>
</div>
