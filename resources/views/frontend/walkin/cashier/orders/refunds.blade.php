        ...
        <tbody>
          @foreach ($orders as $key => $order)
              <tr>
                  ...
                  <td>
                        @if ($order->order_status == 'cancel' || $order->order_status == 'refund')
                          <span class="badge-unverfied">{{translate($order->order_status)}}</span>
                        @elseif($order->order_status == 'completed' || $order->order_status == 'partial_refund_done')
                  ...
                  <td>
                      <span class="badge-unverfied">{{ ucfirst(str_replace('_', ' ', $order->reason_type )) }}</span>
                  </td>
                  <td>
