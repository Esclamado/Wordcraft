...
@section('content')
    ...
    <div class="container pt-5 pb-4">
        <a href="{{ route('walkin.product') }}" class="link-back-cart d-flex align-items-center">
            ...
            @if (Session::has('cart') && count(Session::get('cart')) > 0)
                ...
                <div class="row" id="cart">
                    <div class="col-xxl-8 col-xl-8 mx-auto" style="margin-bottom: 30px;">
                        <div hidden class="shadow-sm bg-white p-3 p-lg-4 rounded text-left" style="margin-bottom:10px;">
                        ...
                        @foreach ($pickup_location as $location)
                            ...
                            <div class="shadow-sm bg-white p-3 p-lg-4 rounded text-left mb-3">
                                <div class="mb-2">
                                    ...
                                    <div
                                        class="row gutters-5 mb-3 text-craft-secondary">
                                            ...
                                            @if ($cartItem['pickup_location'] == $location)
                                                ...
                                                <li class="list-group-item px-0 pl-0">
                                                    <div class="row gutters-5">
                                                        <div class="col-5 d-flex align-items-start align-items-lg-center">
                                                            <div class="d-flex mr-lg-3">
                                                                <div class="form-craft-check"
                                                                style="align-self:flex-end;">
                                                                    <div id="checkbox_item">
                                                                        <input hidden name="chk_item" type="checkbox"
                                                            ...
                                                            <div class="d-block d-flex mr-auto pr-4 ml-lg-0 mr-lg-0">
                                                        ...
                                                        <div
                                                            class="align-self-center d-flex justify-content-center justify-content-lg-start">
                                                            <div>
                                                                <!-- <span
                                                        ...
                                                        <div class="col-lg col-3 align-self-center">
                                                            @if ($cartItem['digital'] != 1)
                                                                <div class="row no-gutters align-items-center aiz-plus-minus mr-2 ml-5 pt-2 pb-2"
                                                        ...
                                                        <div
                                                            class="d-flex align-items-center" style="margin-right: 20px">
                                                            <div>
                                                                <!-- <span
                                                        ...
                                                        <div
                                                            class="col-lg-1 col-1 order-5 order-lg-0 text-center align-self-center">
                                ...
                                <div class="col-xxl-6 col-xl-6 d-flex justify-content-end pr-0">
                                    @if (Auth::check())
                                        <button onclick="checkout()"
                                            class="btn btn-primary fw-600 cart-mobile-ui">{{ translate('Proceed to Payment') }}
                    ...
                    <div class="col-xxl-4 col-xl-4">
                        <div class="shadow-sm bg-white p-3 p-lg-4 rounded text-left">
                            <div class="summary_header">
                                ...
                                <div class="fs-20 fw-500" style="color: #000000; font-style: normal">{{ translate('Summary') }}</div>
                            </div>
                           ...
                           <div class="summary-footer">
                            ...
                            <div class="col-xxl-12 col-xl-12 d-flex justify-content-center pr-0 mt-3">
                                @if (Auth::check())
                                    <button onclick="checkout()"
                                        class="btn btn-prcdtopayment fw-600 cart-mobile-ui">{{ translate('Proceed to Payment') }}
                                        <i class="las la-arrow-right m-2"></i>
                                    </button>
                                @else
                                    <button class="btn btn-primary fw-600 cart-mobile-ui"
...
function set_checkbox(){
  console.log('set_checkbox', set_checkbox);
  var sub_total=0;
  var handling_fee=0;
  @foreach (Session::get('cart') as $key => $cartItem)
      $('#cart #checkbox_item #'+'{{$cartItem['pickup_location']}}_{{$cartItem['id']}}_{{ $cartItem['variant'] }}').prop( "checked", true );
...
function checkout(){
    ...
    $.ajax({
        ...
        success: function(data){
            if(data == 'success'){
                window.location.href = "{{ route('walkin.checkout.shipping_info')}}";
            }else{
                window.location.href = "{{ route('walkin.checkout.shipping_info')}}";
            }
        }
