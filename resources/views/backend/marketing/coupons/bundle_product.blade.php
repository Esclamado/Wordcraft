            ...
            <tbody>
                @foreach ($product_ids as $key => $id)
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="quantity_min_{{ $id }}" min="0" step="1" class="form-control" id="" required>
                        </td>
                        <td>
                            <input type="number" name="quantity_max_{{ $id }}" min="0" step="1" class="form-control" id="" required>
                        </td>
                    </tr>
                @endforeach
            </tbody>
