            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{translate('Online Sales')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <!--Submenu-->
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @if (Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('declined_orders_admin.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['declined_orders_admin.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Declined Orders') }}</span>
                                </a>
                            </li>
                        @endif
                    </ul>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('21', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <i class="las la-money-bill aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{translate('Walkin Orders')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{route('cashier.orders')}}" class="aiz-side-nav-link {{ areActiveRoutes(['cashier.orders'])}}">
                                    <span class="aiz-side-nav-text">{{translate('All Orders')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('cashier.orders.revised')}}" class="aiz-side-nav-link {{ areActiveRoutes(['cashier.orders.revised'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Revised Orders')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('cashier.orders.refunds')}}" class="aiz-side-nav-link {{ areActiveRoutes(['cashier.orders.refunds'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Refunds and Cancellation')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('defective')}}" class="aiz-side-nav-link {{ areActiveRoutes(['defective'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Defective Items')}}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('rejected_refund')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Rejected Refund')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{ translate('User Group') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('customers.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customers.index', 'customer_user_show']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Customer list') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('resellers_list.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['resellers_list.index', 'reseller_user_show']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Reseller List') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('employees_list.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['employees_list.index', 'employee_user_show']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Employee List') }}</span>
                                </a>
                            </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('10', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('all_users.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['all_users.index']) }}">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('worldcraft_stocks.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['worldcraft_stocks.index']) }}">
                                    <span class="aiz-side-nav-text">
                                        {{ translate("Worldcraft Stocks") }}
                                    </span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('worldcraft_stocks_syncing.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['worldcraft_stocks_syncing.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Worldcraft Syncing Stocks Report') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('island_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['island_report.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate("LuzViMin Report") }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('overview_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['overview_report.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate("Overview") }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('products_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['products_report.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate("Products") }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('revenue_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['revenue_report.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate("Revenue") }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('orders_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['orders_report.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate("Orders") }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('variation_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['variation_report.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate("Variation") }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('category_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['category_report.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate("Category") }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('coupon_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['coupon_report.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate("Coupon") }}</span>
                                </a>
                            </li>
                            {{-- <li class="aiz-side-nav-item">
                                <a href="{{ route('tax_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['tax_report.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate("Taxes") }}</span>
                                </a>
                            </li> --}}
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('download_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['download_report.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate("Download") }}</span>
                                </a>
                            </li>
                            {{-- <li class="aiz-side-nav-item">
                                <a href="{{ route('stocks_report.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['stocks_report.index']) }}">
                                    <span class="aiz-side-nav-text">{{ translate("Stocks") }}</span>
                                </a>
                            </li> --}}
                        </ul>
                    </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('11', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('coupon-categories.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['coupon-categories.index','coupon-categories.create','coupon-categories.edit'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Coupon Categories') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('18', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Reward Points System')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('club_points.configs') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{translate('Reward Points Configurations')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('payment-channels.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Payment Channels') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('other-payment-methods.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Other Payment Methods')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('bank_lists.index') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Other Payment Methods Bank Lists') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('store-locations.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['store-locations.index']) }}">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('20', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{route('employees_bulk_upload')}}" class="aiz-side-nav-link {{ areActiveRoutes(['employees_bulk_upload'])}}">
                                    <span class="aiz-side-nav-text">{{translate('Import Employees')}}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
