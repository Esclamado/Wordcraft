...
<div class="aiz-topbar @if(auth()->user()->user_type == 'cashier') w-md-100 l-0 h-90 @endif px-15px px-lg-25px d-flex align-items-stretch justify-content-between">
    ...
    <div class="d-flex justify-content-between align-items-stretch flex-grow-xl-1">
                ...
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                        @if (auth()->user()->user_type == 'cashier')
                            ...
                            @endphp
                            @if($header_logo != null)
                                <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="h-45px">
                            @else
                                <img src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" class="h-45px">
                            @endif
                        @else
        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            ...
            <div class="aiz-topbar-item ml-2 @if (auth()->user()->user_type == 'cashier') mr-3 @endif">
                    ...
                    <a class="dropdown-toggle no-arrow text-dark" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="d-none d-md-block">
                                ...
                                <span class="d-block small opacity-60 text-capitalize">{{Auth::user()->user_type}}</span>
                            </span>
                        </span>
                    </a>
