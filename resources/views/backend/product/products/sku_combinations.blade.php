...
@foreach ($combinations as $key => $combination)
	...
	@if(strlen($str) > 0)
			<tr class="variant">
				...
				<td>
					<input type="text" name="sku_{{ $str }}" value="" class="form-control" style="min-width: 100px;">
				</td>
				<td>
				...
				<td>
					<div class="input-group" data-toggle="aizuploader" data-type="image">
						...
						<div class="form-control file-amount text-elipsis">{{ translate('Choose File') }}</div>
