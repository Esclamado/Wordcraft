        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('shipping_configuration.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="radio mar-btm">
                        <input id="pickup-point-location" class="magic-radio" type="radio" name="shipping_type" value="pickup_point_location" <?php if(\App\BusinessSetting::where('type', 'shipping_type')->first()->value == 'pickup_point_location') echo "checked";?>>
                        <label for="pickup-point-location">{{translate('Pickup Point Location')}}</label>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        5. {{ translate('Pickup Point Location calulation: Fixed rate for each area. If customers purchase multiple products from one seller shipping cost is calculated by the customer shipping area. To configure pickup point location advice Worldcraft API for stock and handling fee') }}.
                    </li>
                </ul>
            </div>
        </div>
