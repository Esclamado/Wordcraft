...
@section('content')
    ...
    <div class="card">
    	...
    	<div class="card-body">
        <div class="card-header row gutters-6 px-0">
  			<div class="col text-center text-md-left">
            <address>
                <strong class="text-main">{{ $order->user->name }}</strong><br>
                {{ $order->user->email }}<br>
                {{ $order->user->phone }}<br>
                {{ $order->pickup_point_location }}<br>
            </address>
                    ...
                    <table>
        				<tbody>
            				...
            				<tr>
            					...
            					<td class="text-right">{{ date('d-m-Y h:i A', $order->date_order_placed) }}</td>
            				</tr>
                            <tr>
                            ...
                            <tr>
            					...
            					<td class="text-right">{{ ucfirst(str_replace('_', ' ', $payment_type)) }}</td>
            				</tr>
        				</tbody>
    				</table>
  				</div>
    		...
    		<div class="clearfix float-right">
    			<table class="table">
        			...
        			<tr>
        				...
        				<td>
        					{{ single_price($order->order_declined_details->sum('price')) }}
        				</td>
        			</tr>
        			<tr>
        				<td>
        				...
        				<td>
        					{{ single_price($order->order_declined_details->sum('tax')) }}
        				</td>
        			</tr>
                    <tr>
        				<td>
        				...
        				<td>
        					{{ single_price($order->order_declined_details->sum('shipping_cost')) }}
        				</td>
        			</tr>
                    <tr>
        				<td>
