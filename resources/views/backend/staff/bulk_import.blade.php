...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{ translate('Employee Bulk Upload') }}</h5>
        </div>
        <div class="card-body">
            ...
            <br>
            <div>
                <a href="{{ static_asset('download/employee_bulk_demo.xlsx') }}" download><button class="btn btn-info">{{ translate('Download CSV')}}</button></a>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6"><strong>{{ translate('Upload Employees') }}</strong></h5>
        </div>
        <div class="card-body">
            <form class="form-horizontal" action="{{ route('employees_bulk_upload.post') }}" method="POST" enctype="multipart/form-data">
                @csrf
