...
<body class="">
	@php
		$cashier = strpos(Route::currentRouteName(), "cashier");
	@endphp
	<div class="aiz-main-wrapper">
        @include('backend.inc.admin_sidenav')
		<div class="aiz-content-wrapper" style="height: auto !important">
            @include('backend.inc.admin_nav')
			<div class="aiz-main-content">
				<div class="px-15px px-lg-25px @if($cashier !== false) py-15px py-lg-25px @endif">
                    @yield('content')
				</div>
