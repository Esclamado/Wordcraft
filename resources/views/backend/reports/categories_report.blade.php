                    ...
                    <tbody>
                        @foreach ($categories as $key => $category)
                            <tr>
                                ...
                                <td>
                                    @php
                                        $product_ids = \App\Product::where('category_id', $category->id)
                                            ->pluck('id');

                                        $item_sold = \App\OrderDetail::whereIn('product_id', $product_ids)
                                            ->count();
                                    @endphp
                                ...
                                <td>
                                    @php
                                        ...
                                        $net_sales = \App\OrderDetail::whereIn('product_id', $product_ids)
                                            ->sum('price');
                                    @endphp
                                ...
                                <td>
                                    @php
                                        echo $product = \App\Product::where('category_id', $category->id)
                                            ->count();
                                    @endphp
                                </td>
                                <td>
                                    @php
                                        ...
                                        $order_details = \App\OrderDetail::whereIn('product_id', $product_ids)
                                            ->pluck('order_id');

                                        $orders = \App\Order::whereIn('id', $order_details)
                                            ->count();
                                    @endphp
    ...
    <script>
        ...
        @if ($date != null)
            ...
            @foreach ($period as $date_period)
                ...
                @php
                    $day_number = date('d', strtotime($date_period));
                    ...
                    $sorted_by_date_items_sold[] = \App\OrderDetail::where('payment_status', 'paid')
                        ->whereDay('created_at', $day_number)
                    ...
                    $sorted_by_date_orders_data[] = \App\Order::whereDay('created_at', $day_number)
                        ->whereMonth('created_at', $month)
                        ->whereYear('created_at', $year)
                        ->count();
                @endphp
            ...
            @foreach ($sorted_by_date_items_sold as $date_items_sold)
                chart_item_sold.push("{{ $date_items_sold }}")
            @endforeach
        ...
        @else
            ...
            @foreach ($items_sold_data as $key => $item_sold)
                chart_item_sold.push("{{ $item_sold }}")
            @endforeach

            @foreach ($net_sales_data as $key => $net_sale)
                chart_net_sales.push("{{ $net_sale }}")
            @endforeach
