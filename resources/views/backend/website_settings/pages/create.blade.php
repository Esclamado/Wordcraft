	...
	<form action="{{ route('custom-pages.store') }}" method="POST" enctype="multipart/form-data">
		...
		<div class="card-body">
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" placeholder="Title" name="title">
						@if ($errors->has('title'))
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<div class="input-group">
						...
						<input type="text" class="form-control{{ $errors->has('slug') ? ' is-invalid' : '' }}" placeholder="{{ translate('Slug') }}" name="slug">
					</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<textarea
						class="aiz-text-editor form-control{{ $errors->has('content') ? ' is-invalid' : '' }}"
