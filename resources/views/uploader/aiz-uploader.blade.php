<div class="modal fade" id="aizUploaderModal" data-backdrop="static" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-adaptive modal-mobile" role="document">
        <div class="modal-content h-100">
                    ...
                    <ul class="nav nav-tabs border-0">
                        <li class="nav-item">
                            <a class="nav-link active font-weight-medium text-dark" data-toggle="tab"
                                href="#aiz-select-file" onclick="showButton()">{{ translate('Select File') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link font-weight-medium text-dark" data-toggle="tab" href="#aiz-upload-new"
                                onclick="hideButton()">{{ translate('Upload New') }}</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="modal-footer justify-content-between bg-light">
                ...
                <button type="button" class="btn btn-sm btn-primary" data-toggle="aizUploaderAddSelected"
                    id="attach_file_btn">{{ translate('Attach File/s') }}</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    function hideButton() {
		var btn = document.getElementById('attach_file_btn');
